...
Guidebooks:
- [Cloud-Optimized Geospatial Formats Guide](https://guide.cloudnativegeo.org/) - Methods for Generating and Testing Cloud-Optimized Geospatial Formats
- [Datacube Guide](https://developmentseed.org/datacube-guide/) - Helping people avoid mistakes when producing and using datacubes
- [Warp Resample Profiling](https://developmentseed.org/warp-resample-profiling/) - Exploring all the Python resampling/reprojection options
- [Zarr Visualization Report](https://nasa-impact.github.io/zarr-visualization-report/) - Methods and benchmarks for visualizing Zarr

Teaching:

- [2025 AGU Workshop - Open Source Geospatial Workflows in the Cloud](https://agu2025.workshops.geojupyter.org/) - An eight-hour workshop to "learn about tools and techniques for data cccess, analysis, visualization, storytelling, and sharing in the Python and Jupyter ecosystem"
- [2024 AGU Workshop - PyGMT](https://www.generic-mapping-tools.org/agu24workshop/intro.html) - An eight-hour pre-conference workshop on "mastering geospatial visualizations with GMT/PyGMT"
